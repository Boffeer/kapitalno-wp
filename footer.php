...
<footer class="footer">
	<div class="wrapper footer__wrapper">
		<a href="<?php echo get_home_link(); ?>" class="footer__logo">Капитально</a>
		<div class="footer__socials socials">
			<?php if ($contacts['facebook']) : ?>
				<a href="<?php echo $contacts['facebook']; ?>" class="socials__link socials__link--facebook footer__socials-link">
			...
			<?php if ($contacts['instagram']) : ?>
				<a href="<?php echo $contacts['instagram']; ?>" class="socials__link socials__link--instagram footer__socials-link">
			...
			<?php endif; ?>
			<?php if ($contacts['vk']) : ?>
				<a href="<?php echo $contacts['vk']; ?>" class="socials__link socials__link--vk footer__socials-link">
					<svg xmlns="http://www.w3.org/2000/svg" class="socials__link-icon" width="60" height="60" viewBox="0 0 60 60" fill="none">
			...
			<ul class="footer__nav-list">
				<?php foreach ($footer_menu_items as $menu_item) : ?>
					<li class="footer__nav-item">
						<a href="<?php echo $menu_item->url ?>" class="footer__nav-link"><?php echo $menu_item->title; ?></a>
					</li>
				<?php endforeach; ?>
			</ul>
		</nav>
		<div class="footer__privacy">
			...
			<a target="_blank" href="<?php echo $contacts['privacy'] ?>" class="footer__privacy-link">Политика конфиденциальности</a>
		</div>
	</div>
</footer>
<div class="popups">
						...
						<div class="input__field">
							<label class="quiz-step__privacy checkbox">
								...
								<p class="quiz-step__desc">
									Я согласен с
									<a class="link--regular" target="_blank" href="<?php echo $contacts['privacy']; ?>">политикой конфиденциальности</a>
								</p>
							</label>
						</div>
					</div>
